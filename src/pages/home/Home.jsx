    ...
    <>
      ...
      <div className={styled.coverContainer}>
        <div className={styled.backgroundCover}>
          ...
          <h2>
            Hi, I’m Zahra Rostami, a passionate Frontend Developer specializing
            in creating modern and responsive web applications. I focus on
            training and working with the React programming language to build
